...
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{images/input_iterator}
    \caption*{Input}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{images/output_iterator}
    \caption*{Output}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{images/forward_iterator}
    \caption*{Forward}
\end{minipage}
...
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{images/bidirectional_iterator}
    \caption*{Bidirectional}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{images/random_access_iterator}
    \caption*{Random Access}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{images/contiguous_iterator}
    \caption*{Contiguous}
\end{minipage}
