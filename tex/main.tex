...
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{input_iterator}
    \caption*{Input}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{output_iterator}
    \caption*{Output}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{forward_iterator}
    \caption*{Forward}
\end{minipage}
...
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{bidirectional_iterator}
    \caption*{Bidirectional}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{random_access_iterator}
    \caption*{Random Access}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    \includesvg[width=\linewidth]{contiguous_iterator}
    \caption*{Contiguous}
\end{minipage}
