...
\subsubsection{Virtual Address Translation (High level)}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{VirtualAddressTranslation.png}\\[0.3em]
    \caption{Virtual address translation: virtual page number + offset mapped to a physical frame number + offset (TLB/page table).}
