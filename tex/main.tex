...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\linewidth]{MaxHeapInsert1.png}\\[0.4em]
    \includegraphics[width=0.7\linewidth]{MaxHeapInsert2.png}\\[0.4em]
    \includegraphics[width=0.7\linewidth]{MaxHeapInsert3.png}\\[0.4em]
    \includegraphics[width=0.7\linewidth]{MaxHeapInsert4.png}\\[0.4em]
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{VirtualAddressTranslation.png}\\[0.3em]
